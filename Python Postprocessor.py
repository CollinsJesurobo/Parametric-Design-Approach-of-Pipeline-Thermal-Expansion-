...
SHEET1.merge_range('A1:G1', 'MAXIMUM AND MINIMUM DISPLACEMENT WITH CORRESPONDING WORST LOADCASE,WORST LOAD CONDITION AND NODE WHERE IT OCCURS')
...
SHEET2.merge_range('A1:F1', 'DISPLACEMENTS RESULTS FOR ALL PIPELINE NODES FOR EACH LOADCASE AND CORRESPONDING LOAD CONDITIONS')
...
SHEET1.write_row('B2',['U1(mm)','U2(mm)','U3(mm)','WorstLoadcase','LoadCondition','Node'],format_title)
...
SHEET1.write_row('A10', ['Loadcase','Thickness(mm)','Expansion(mm)'],format_title)

SHEET2.write_row('A2',['Loadcase','LoadCondition','Node','U1(mm)','U2(mm)','U3(mm)'],format_title)
...
def output2():
        SHEET1.write('B3', '=max(Sheet2!D2:D100000)',format_table_headers)   # maximum displacement in axial direction-max(U1)
        SHEET1.write('C3', '=max(Sheet2!E2:E100000)',format_table_headers)   # maximum displacement in lateral direction-max(U2)
        SHEET1.write('D3', '=max(Sheet2!F2:F100000)',format_table_headers)   # maximum displacement in vertical direction-max(U3)
        SHEET1.write('B4', '=min(Sheet2!D2:D100000)',format_table_headers)   # minimum displacement in axial direction-min(U1)
        SHEET1.write('C4', '=min(Sheet2!E2:E100000)',format_table_headers)   # minimum displacement in lateral direction-min(U2)
        SHEET1.write('D4', '=min(Sheet2!F2:F100000)',format_table_headers)   # minimum displacement in vertical direction-min(U3)
        ...
        ### WORST LOADCASE AND LOADCONDITION CORRESPONDING TO MAXIMUM AND MINIMUM EXPANSION VALUES
        SHEET1.write('E3','=INDEX(Sheet2!A2:A100000,MATCH(MAX(Sheet2!D2:D100000),Sheet2!D2:D100000,0))',format_table_headers)
        SHEET1.write('F3','=INDEX(Sheet2!B2:B100000,MATCH(MAX(Sheet2!D2:D100000),Sheet2!D2:D100000,0))',format_table_headers)
        SHEET1.write('G3','=INDEX(Sheet2!C2:C100000,MATCH(MAX(Sheet2!D2:D100000),Sheet2!D2:D100000,0))',format_table_headers)
        SHEET1.write('E4','=INDEX(Sheet2!A2:A100000,MATCH(MIN(Sheet2!D2:D100000),Sheet2!D2:D100000,0))',format_table_headers)
        SHEET1.write('F4','=INDEX(Sheet2!B2:B100000,MATCH(MIN(Sheet2!D2:D100000),Sheet2!D2:D100000,0))',format_table_headers)
        SHEET1.write('G4','=INDEX(Sheet2!C2:C100000,MATCH(MIN(Sheet2!D2:D100000),Sheet2!D2:D100000,0))',format_table_headers)
output2()
...
SHEET1.write('C11','=VLOOKUP(A11,Sheet2!$A$3:$F$100000,4,MAX(Sheet2!D3:D100000))',format_table_headers)
SHEET1.write('C12','=VLOOKUP(A12,Sheet2!$A$3:$F$100000,4,MAX(Sheet2!D3:D100000))',format_table_headers)
SHEET1.write('C13','=VLOOKUP(A13,Sheet2!$A$3:$F$100000,4,MAX(Sheet2!D3:D100000))',format_table_headers)
SHEET1.write('C14','=VLOOKUP(A14,Sheet2!$A$3:$F$100000,4,MAX(Sheet2!D3:D100000))',format_table_headers)
SHEET1.write('C15','=VLOOKUP(A15,Sheet2!$A$3:$F$100000,4,MAX(Sheet2!D3:D100000))',format_table_headers)
SHEET1.write('C16','=VLOOKUP(A16,Sheet2!$A$3:$F$100000,4,MAX(Sheet2!D3:D100000))',format_table_headers)
...
chart.add_series({
        ...
        'values': '=SHEET1!$C$11:$C$16'})                       #Expansion in y-axis
